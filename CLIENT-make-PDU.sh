...
DATA=`cat CLIENTE4-CLIENTE1-mensagem.txt`
...
echo $VERSION$IHL$TOS$LENGTH$ID$FLAGS$OFFSET$TTL$PROTOCOL$CHECKSUM$SOURCEIP$DESTINIP$DATA >> CLIENTE1-SERVER1-quadro.txt