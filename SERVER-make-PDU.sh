...
DATA=`cat SERVER2-SERVER1-segmento.txt`
...
echo $VERSION$IHL$TOS$LENGTH$ID$FLAGS$OFFSET$TTL$PROTOCOL$CHECKSUM$SOURCEIP$DESTINIP$DATA > SERVER1-INTERNET1-quadro.txt
